About pystencils-reco-feedstock
===============================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pystencils-reco-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13111&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pystencils-reco-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pystencils-reco` can be installed with `conda`:
...
```
mamba install pystencils-reco
```

It is possible to list all of the versions of `pystencils-reco` available on your platform with `conda`:
...
```
mamba search pystencils-reco --channel conda-forge
```
...
mamba repoquery search pystencils-reco --channel conda-forge

# List packages depending on `pystencils-reco`:
mamba repoquery whoneeds pystencils-reco --channel conda-forge

# List dependencies of `pystencils-reco`:
mamba repoquery depends pystencils-reco --channel conda-forge
```
